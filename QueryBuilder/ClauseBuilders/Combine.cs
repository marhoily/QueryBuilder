...
namespace SqlKata
{
    public abstract class AbstractCombineBuilder : AbstractClauseBuilder
    {
    }

    public sealed class CombineBuilder : AbstractCombineBuilder
    {
        /// <summary>
    ...
    public class RawCombineBuilder : AbstractCombineBuilder
    {
